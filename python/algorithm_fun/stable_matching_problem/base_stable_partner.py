...
boys = [TagPartner("li_lei",None,0,[2,3,1,0 ]),TagPartner("yang_peng",None,0,[2,1,3,0]),TagPartner("liang_yuancheng",None,0,[0,2,3,1]),TagPartner("dong_zehao",None,0,[ 1,3,2,0 ])]

girls = [TagPartner("abby",None,0,[0,3,2,1]),TagPartner("rose",None,0,[0,1,2,3]),TagPartner("han_meimei",None,0,[0,2,3,1]),TagPartner("lu_se",None,0,[1,0,3,2])]
